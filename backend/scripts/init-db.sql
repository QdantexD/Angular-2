...
-- Run: node setup.js to generate a new hash if needed
INSERT INTO users (username, email, password, role, full_name) 
VALUES ('admin', 'admin@battlenet.com', '$2a$10$MZnjGKBatKam6qVF1e3OwuL980xWh9uh7QFYxICaMp.VmSd.y8vjC', 'admin', 'Administrator')
